...
<div class="container">
    ...
    <p lang="EN">I will be studying towards my PhD in 2017 at the University of Cambridge. I will be under the supervision of Dr Mateja Jamnik, with the tentative thesis title &ldquo;Automating representation change across domains for reasoning.&rdquo;</p>
    <p lang="FR">Je vais étudier vers mon doctorat en 2017 à l&rsquo;University of Cambridge. Je serai sous la supervision de Dr Mateja Jamnik, avec la titre de thèse provisoire &laquo;&nbsp;Automating representation change across domains for reasoning.&nbsp;&raquo;</p>
    ...
    <p lang="EN">During Term 3 2017, I am lecturing the paper &ldquo;COSC122: Introduction to Computer Science.&rdquo; This is an amazing experience, helping teach one of the core computer science papers that builds the ground-work for many other courses.</p>
    <p lang="FR">Durant la Periode 3 2017, je vais donner des leçons pour &laquo;&nbsp;COSC122: Introduction to Computer Science.&nbsp;&raquo; Ceci sera une experience fantastique, aid enseigner un de les cours essentials à l&rsquo;informatique que consolider le connaissance pour beaucoup d&rsquo;autres cours.</p>

    <h3 lang="EN">Tutor, 2015&ndash;2017</h3>
    <h3 lang="FR">Tuteur, 2015&ndash;2017</h3>
    <p lang="EN">I am currently working as a tutor at the University of Canterbury in the Department of Computer Science and Software Engineering.</p>
    <p lang="FR">Je travaille comme un tuteur à l&rsquo;University of Canterbury en le Department of Computer Science and Software Engineering.</p>
    <h4>2017</h4>
    <ul class="tutoring-list">
      <li>COSC121S1: Introduction to Computer Programming</li>
      <li>COSC262S1: Algorithms</li>
      <li>COSC367S1: Artificial Intelligence</li>
      <li>COSC480S1: Computer Programming</li>
    </ul>
    <h4 lang="EN">Previous Years</h4>
    <h4 lang="FR">Les Années Précédentes</h4>
    <ul class="tutoring-list">
      <li>COSC121S1: Introduction to Computer Programming (2015)</li>
      <li>COSC122S2: Introduction to Computer Science (2015)</li>
      <li>COSC262S1: Algorithms (2016)</li>
